...
namespace ACdb
{
    ...
    {
        private static readonly string Address = "https://acdb.tv"; // TODO BUILD Make sure it's correct
        ...
        public static string WebSiteUrl { get; } = Address;
        public static string ApiBaseUrl { get; } = $"{Address}/api"; 
        ...
        public static string TagDeletedUrl { get; } = ApiBaseUrl + "/tag-removed";
        ...
        public static string ScheduledTaskName { get; } = "Checking for pending ACdb.tv jobs";
