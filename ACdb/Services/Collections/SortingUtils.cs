...
namespace ACdb.Services.Collections
{
    class SortingUtils
    {
        ...
        private static readonly Regex SortNameRegex = new Regex(@"!!!\[\d+\]");

        public static int MinutesUntil2100(DateTime currentDate)
        {
            DateTime year2100 = new DateTime(2100, 1, 1);
        ...
        public static string GetDefaultSortName(string title)
        {
            ...
            string[] articles = new[] { "the ", "a ", "an ", "das ", "der ", "el ", "la " };
            ...
            sortName = string.Join(" ", sortName.Split(new[] { ' ' }, StringSplitOptions.RemoveEmptyEntries));
